                                                ...
                                                uint32_t tag)
{
    ...
    struct cache_line *start = &cache_system->cache_lines[startSet];
    struct cache_line *cl;
    uint32_t counter = 0;
    //printf("STARTEDMEMLOOKUP\n");
    //printf("%d start status\n", start->status);
    //printf("%d start tag\n", start->tag);
    //printf("%d\n", counter + cache_system->associativity);
    // printf("START CACHE PRINT\n");
    // printCache(cache_system);
    ...
    // while(counter < counter + cache_system->associativity) {
    //     cl = &cache_system->cache_lines[counter + startSet];
    //     printf("cl\n");
    //     printf("%d\n", cl->tag);
    //     if(cl->tag == tag) {
    ...
    //     cl = &cache_system->cache_lines[i + startSet];
    //     printf("cl\n");
    //     printf("%d\n", cl->tag);
    //     if(cl->tag == tag) {
    //         printf("FOUND\n");
